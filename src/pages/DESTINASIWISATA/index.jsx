  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-start justify-start mx-auto w-full">
        ...
        <div className="flex flex-col md:gap-10 gap-[247px] items-center mt-[74px] w-full">
          <List
            className="flex flex-col gap-[33px] items-center max-w-[1115px] mx-auto md:px-5 w-full"
              ...
              <div className="flex md:flex-col flex-row md:gap-[47px] items-center justify-between w-full">
                ...
                <div className="flex flex-col items-start justify-start">
                  ...
                  <Button
                    ...
                    onClick={() => navigate("/destinasiwisataone")}
                    shape="round"
                    color="green_600"
                    size="xs"
                    variant="fill"
...
export default DESTINASIWISATAPage;
