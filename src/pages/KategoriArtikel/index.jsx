...
const KategoriArtikelPage = () => {
  ...
  const table1Columns = React.useMemo(() => {
    ...
    return [
      table1ColumnHelper.accessor("rowno", {
        cell: (info) => (
          <div className="flex flex-col justify-start p-2.5">
            <div className="flex flex-row gap-[25px] items-start justify-start mr-[369px] w-[16%] md:w-full">
              <Text
      ...
      table1ColumnHelper.accessor("rowrectanglesixtythree", {
        cell: (info) => (
          <Text
      ...
      table1ColumnHelper.accessor("rowartikelone", {
        cell: (info) => (
      ...
      table1ColumnHelper.accessor("rowstatusone", {
        cell: (info) => (
          <div className="flex flex-row items-start justify-center pr-[15px] py-[15px]">
            <Img
      ...
      table1ColumnHelper.accessor("aksi", {
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins gap-[25px] items-start justify-start mx-auto p-[23px] sm:px-5 w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start md:ml-[0] ml-[53px] md:px-5 w-[48%] md:w-full">
          <Text
          ...
          <Line className="bg-gray-700 md:h-0.5 h-[45px] ml-6 md:ml-[0] md:mt-0 my-0.5 w-0.5 md:w-full" />
          <Text
        ...
        <div className="flex flex-col items-center max-w-[1286px] mb-[46px] mx-auto md:px-5 w-full">
          <div className="bg-white-A700 border-black-900_33 border-solid border-t border-x flex flex-col items-start justify-start p-6 sm:px-5 rounded-[10px] shadow-bs2 w-full">
            <div className="flex sm:flex-col flex-row md:gap-10 items-end justify-between ml-1 md:ml-[0] w-full">
              <Text
                className="mb-0.5 sm:mt-0 mt-[7px] text-gray-700 text-xl"
                size="txtPoppinsMedium20Gray700"
              >
                Tabel Artikel Kategori
              </Text>
              <Text
...
export default KategoriArtikelPage;
