  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-poppins items-start justify-start mx-auto w-full">
        ...
        <div className="flex flex-col md:gap-10 gap-[306px] items-center mt-[72px] w-full">
          <List
            className="flex flex-col gap-[33px] items-center max-w-[1111px] mx-auto md:px-5 w-full"
